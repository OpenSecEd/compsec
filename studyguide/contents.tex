...
\mode<article>{%
\subsection{S0 What's up with security?}\label{security-society-seminar}
\input{security-society-abstract.tex}
}

\mode<article>{%
\subsection{Foundations and usability}\label{foundations}
\input{foundations-abstract.tex}
}

\mode<article>{%
\subsection{Information theory}\label{infotheory}
...
\mode<article>{%
\subsection{Identification and authentication}\label{auth}
\input{auth-lit.tex}
}
...
\mode<article>{%
\subsection{Protocols and formal verification}\label{proto}
\input{fverif-lit.tex}
}

\mode<article>{%
\subsection{Access control}\label{ac}
\input{accessctrl-lit.tex}
}

\mode<article>{%
\subsection{Trusted computing}\label{trustcomp}
...
\mode<article>{%
\subsection{Software security}\label{software}
\input{software-lit.tex}
}

\mode<article>{%
\subsection{L7 Tools of the trade}\label{tools}
